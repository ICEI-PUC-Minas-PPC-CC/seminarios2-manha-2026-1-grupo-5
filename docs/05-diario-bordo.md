# S2-05 — Diário de Bordo do Grupo
...
> **Importante:** Mantenha este diário atualizado ao longo do semestre. Ele será a base para o cronograma do relatório de atividades no APC. Registre **todas** as atividades realizadas pelo grupo, mesmo as menores.
...
*(Relatar como foi a oficina: o que funcionou bem, dificuldades encontradas, reação dos participantes, etc.)*

### Lições aprendidas

*(O que o grupo faria diferente? O que deu certo e pode ser replicado?)*
